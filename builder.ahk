...
FileSelectFile, old_file_xls, , % A_ScriptDir, Select the OLD TAS report, *.xls
if (old_file_xls = "")
	ExitApp

FileSelectFile, new_file_xls, , % A_ScriptDir, Select the NEW TAS report, *.xls
if (new_file_xls = "")
	ExitApp
...
report_file_xlsx := A_ScriptDir "\" new_date " tas-diff-add-del.xlsx"
